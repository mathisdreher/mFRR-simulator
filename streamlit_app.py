...
st.markdown(f"### With :red[{capacity_MW} MW] of flex capacity, you could earn :red[**€{total_revenue}**] based on an assumption of :red[{activation_hours_per_year}] activation days per year with Flexcity.")
